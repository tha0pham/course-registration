 ...
 * @author Thao
 */
@WebServlet(name = "DeleteMajorServlet", urlPatterns = {"/DeleteMajorServlet"})
public class DeleteMajorServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            message = major.getName() + " has been deleted.";
        } catch (Exception e) {
            message = e.toString() + " " + e.getMessage();
        } finally {
            request.setAttribute("message", message);
            request.getRequestDispatcher("list_major.jsp").forward(request, response);
        }
    }
