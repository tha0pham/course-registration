            ...
            <table class="myListTable">
                <tr>
                    <td colspan="2" bgcolor="#008080">
                        <p align="center"><b><font face="Tahoma" color="#FFFF00">Login Page</font></b></td>
                </tr>
                <tr>
                    <td width="50%" align="right"><b><font face="Tahoma">Username:</font></b></td>
                    <td width="49%"><input type="text" name="username" size="20"></td>
                </tr>
                <tr>
                    <td width="50%" align="right"><b><font face="Tahoma">Password:</font></b></td>
                    <td width="49%"><input type="password" name="password" size="20"></td>
                </tr>
                <tr>
                    <td width="50%">&nbsp;</td>
                    <td width="49%">
