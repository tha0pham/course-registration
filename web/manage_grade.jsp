                ...
                <section id="content">
                    <div class="inside">        
                        ...
                        <form>
                            ...
                            <p><a href="report_average_grade.jsp?clazz=<%=clazz == null ? "" : clazz.getId()%>&semester=<%=semesterId%>&year=<%=yearId%>">Calculate Average</a></p>
                            <%
                                if (clazz != null) {
                            %>
                            <table class="myInfoTable"
                                ...
                                <tr>
                                    <td><%=clazz.getMidterm()%></td>
                                    <td><%=clazz.getFinalExam()%></td>
                                    <td><%=clazz.getAssignment()%></td>
                                </tr>
                            </table>
                            <p>&nbsp;</p>
                            <%
                            ...
                            <table class="myListTable">
                                ...
                                %>
                                <tr>
                                <input type="hidden" name="studentId" value="<%=each.getId()%>"/>
                                <td><%=i%></td>
                                <td><%=each.getCode()%></td>
                                <td><%=each.getLastName() + " " + each.getFirstName()%></td>
                                <td><input name="midterm" type="text" id="midterm" size="5" maxlength="3" value="<%=reg.getMidterm()==null?"0":reg.getMidterm()%>"></td>
                                <td><input name="final" type="text" id="final" size="5" maxlength="3" value="<%=reg.getFinalExam()==null?"0":reg.getFinalExam()%>"></td>
                                <td><input name="assignment" type="text" id="assignment" size="5" maxlength="3" value="<%=reg.getAssignment()==null?"0":reg.getAssignment()%>"></td>
                                </tr>
                                <%
                                    }
                                %>
                            ...
                            %>
                            <input type="submit" name="btnSave" value="Save" formaction="ManageGradeServlet"/>
                        </form>
                        <p>${message}</p>
