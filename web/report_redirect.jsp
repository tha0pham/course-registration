...
<html lang="en">
    <head>
        ...
        src="js/ie_png.js"></script>
             <script type="text/javascript">
                ie_png.fix('.png, footer, header nav ul li a, .nav-bg, 
    ...
    <%
        ...
        try {
            semester
                    = semesterDAO.findSemesterByID(Integer.parseInt(request.getParameter("semester")));
        } catch (NumberFormatException e) {
            semester
                    = semesterDAO.findSemesterByID(1);
        }
        ...
        try {
            ...
            year
                    = yearDAO.findYearByID(1);
        }

        List<Clazz> clazzes
                = clazzDAO.findClazzBySemester(semester, year);
        String keyword = request.getParameter("keyword");
        if (keyword
                != null) {
            clazzes = clazzDAO.search(keyword,
                    semester, year);
        }
    %>
        ...
        <div class="wrap">
                ...
                <div class="container">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li class="last"><a href="sitemap.jsp"  class="m5">Site Map</a></li>
                        </ul>
                    </nav>
            ...
            <div class="container">
                    ...
                    <form action="MailServlet" id="newsletter-form">
                        <fieldset>
                            <div class="rowElem">
                                ...
                                <div class="clear"><a href="#" class="fright" onClick="document.getElementById('newsletter-form').submit()">Submit</a></div>
                            </div>
                        </fieldset>
                    </form>
                ...
                <section id="content">
                    <div class="inside">        
                        <!-- modification starts-->
                        <form name="fmClazz" method="post">
                            <label for="semester">Semester:</label>
                            <br/>
                            <select name="semester" onchange="submit()">
                                <%
                                    if (semesters != null && semesters.size()
                                            != 0 && years != null && years.size() != 0) {
                            ...
                            <table class="myListTable">
                                ...
                                <tr>
                                    ...
                                    <td><a href="report_exam_signature.jsp?clazz=<%=each.getId()%>">View Grade Sheet</a></td>
                                    <td><a href="report_view_class_grade.jsp?clazz=<%=each.getId()%>">View Class Grade</a></td>
                                </tr>
                                <%
                                        }
                                    }
                            ...
                            <div>
                                <input type="button" name="btnToAdd" value="Add New Class" 
                                       onclick="location.href = 'edit_clazz.jsp'" />
                            </div>
                        </form>
                        <p>${message}</p>
                        <!-- modification ends-->
            ...
            <div class="container">
                <div class="inside">
                    <div class="wrapper">
                        ...
                        <div class="aligncenter"><a rel="nofollow" href="#" class="new_window">Website template</a> designed by TemplateMonster.com<br>
                            <a href="#" class="new_window">3D Models</a> provided by Templates.com</div>
                    </div>
                </div>
            </div>
        </footer>
