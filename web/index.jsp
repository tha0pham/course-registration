    ...
    <body id="page1">
      ...
      <section id="content">
         ...
         <div class="inside">
            ...
            <p class="p0">This website template has several pages: <a href="index.jsp">Home</a>, <a href="about-us.jsp">About us</a>, <a href="articles.jsp">Articles</a> (with Article page), <a href="contact-us.jsp">Contact us</a> (note that contact us form â doesnât work), <a href="sitemap.jsp">Site Map</a>.</p>
         </div>
      </section>
   </div>
</div>
