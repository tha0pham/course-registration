...
<%
        ...
        if (keyword != null) {
            faculties = facultyDAO.search(keyword);
        }
    %>
...
esse quam nihil molestiae. </li>
      ...
      <section id="content">
         <div class="inside">
        <form method="post" name="fmFaculty" action="">
            <table class="myListTable">
                ...
                <tr>
                    <td><%=i%></td>
                    <td>
                        <a href="edit_faculty.jsp?id=<%=each.getId()%>"><%=each.getName()%></a>
                    </td>
                    <td><%=each.getDescription()%></td>
                    <td><a href="DeleteFacultyServlet?id=<%=each.getId()%>">Delete</a></td>
                </tr>
                <%
                        }
                    }
            ...
            <br/>
            <input type="button" name="btnToAdd" value="Add New Faculty" onclick="location.href = 'edit_faculty.jsp'"/>
        </form>     
        <p>${message}</p>
