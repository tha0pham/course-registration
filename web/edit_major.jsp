            ...
            <div class="container">
                ...
                <section id="content">
                    <div class="inside">        
                        ...
                        <h1>New Major</h1>
                        <form method="post" action="EditMajorServlet" id="major" class="fmNonPeople">
                            <input type="hidden" name="updateID" value="<%=major == null ? "" : major.getId()%>"/>
                            <table class="myEditTable">
                                <tr>
                                    <th>Name:</th>
                                    <td>
                                        <input type="text" name="name" size="100%" value="<%=major == null ? "" : major.getName()%>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Offered by:</th>
                                    <td>
                                        <select name="faculty">
                                            ...
                                            %>
                                            <option value="<%=each.getId()%>" <%=facultyID == each.getId() ? "selected" : ""%>>
                                                <%=each.getName()%></option>
                                                <%
                                                    }
                                                %>
                                ...
                                <tr>
                                    <th>Description:</th>
                                    <td>
                                        <input type="text" name="description" size="100%" value="<%=major == null ? "" : major.getDescription()%>"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input type="submit" name="btnSave" value="Save Major"/>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
